  ...
  <section class="py-20 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
    <div class="container mx-auto px-6">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
        <div>
          <h3 class="text-4xl font-bold" id="total-votes">
        ...
        <div>
          <h3 class="text-4xl font-bold" id="total-candidates"><? $nb_candidates ?></h3>
          <p class="opacity-80">Candidats</p>
        </div>
        <div>
          <h3 class="text-4xl font-bold" id="total-voters"><? $nb_etudiantes ?></h3>
